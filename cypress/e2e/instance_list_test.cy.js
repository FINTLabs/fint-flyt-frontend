describe('Testing instance list', () => {
    ...
    it('instance table and panel should have correct information', () => {
        ...
        cy.get('#rf > .navds-table__expanded-row-cell > .navds-table__expanded-row-collapse > .navds-table__expanded-row-content > #instance-panel > .navds-box').should('contain.text', '02/06/23 13:40')
        cy.get('#rf > .navds-table__expanded-row-cell > .navds-table__expanded-row-collapse > .navds-table__expanded-row-content > #instance-panel > .navds-box').should('contain.text', 'Instans registrert')
    })
