...
const newCaseClassificationFields =
    '#mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.klasse\\.elementMappings\\.0\\.valueMappingPerKey';
const recordFields =
    '#mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.valueMappingPerKey';
const correspondentFields =
    '#mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.korrespondansepart\\.fromCollectionMappings\\.0\\.elementMapping\\.valueMappingPerKey';
const correspondentDndFields =
    '#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.korrespondansepart\\.fromCollectionMappings\\.0\\.elementMapping\\.valueMappingPerKey';
...
describe('Testing fill new configuration', () => {
    beforeEach(() => {
        ...
        cy.intercept('POST', '**/integrasjoner', { fixture: 'postFixture.json' }).as(
            'postIntegration'
        );
        cy.intercept('POST', '**/konfigurasjoner', { fixture: 'postFixture.json' }).as(
            'postConfiguration'
        );
        cy.intercept('GET', '**/integrasjoner', { fixture: 'allIntegrations.json' }).as(
            'getAllIntegrations'
        );
        cy.intercept(
            'GET',
        ...
        cy.intercept('GET', '**/metadata?kildeapplikasjonId=*', { fixture: 'metadata.json' }).as(
            'getMetadata'
        );
        cy.intercept('GET', '**/integrasjoner?sourceApplicationId=*', {
            fixture: 'integrationForSource2.json',
        }).as('getAllIntegrationBySourceApplicationId');
        cy.intercept('GET', '**/metadata?kildeapplikasjonId=2&bareSisteVersjoner=false', {
            fixture: 'metadata.json',
        }).as('getMetadata');
        cy.intercept('GET', '**/metadata/4/instans-metadata', {
            fixture: 'instansMetadata.json',
        }).as('getInstansMetadata');
        cy.intercept(
            'GET',
        ...
        cy.intercept(
            'GET',
            '**/value-convertings?page=0&size=100&sortProperty=fromApplicationId&sortDirection=ASC&excludeConvertingMap=false',
            { fixture: 'valueconverting/valueconvertings.json' }
        ).as('getValueconvertings');
        cy.intercept(
            'GET',
            '**/api/intern/arkiv/kodeverk/klasse?klassifikasjonssystemLink=https%3A%2F%2Fkodeverk.no%2Farkiv%2Fnoark%2Fsystemid%2FFJELL',
            { fixture: 'kodeverk/klasse.json' }
        ).as('getKodeverkKlasse');
        cy.intercept('GET', /.*\/arkiv\/kodeverk\/(?!klasse\?).*/, {
            fixture: 'kodeverk/mock.json',
        }).as('getKodeverk');
    });
    ...
    it('should fill configuration, text and dropdown', () => {
        ...
        cy.get(
            '#list-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.klasse\\.elementMappings > #add-icon'
        ).click();
        ...
        cy.get(
            `${newCaseClassificationFields}\\.klassifikasjonssystem\\.mappingString-option-2`
        ).click();
        ...
        cy.get(
            '#list-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings > #add-icon'
        ).click();
        cy.get(
        ...
        cy.get(
            '#list-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.korrespondansepart\\.fromCollectionMappings > #add-icon'
        ).click();
        cy.get(
            '#selectable-value-mapping-wrapper-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.korrespondansepart\\.fromCollectionMappings\\.0 > .MuiButtonBase-root'
        ).click();
        cy.get(
            '#list-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.korrespondansepart\\.fromCollectionMappings\\.0\\.instanceCollectionReferencesOrdered > #add-icon'
        ).click();
        cy.get(
        ...
        cy.get(
            '#list-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.dokumentbeskrivelse\\.elementMappings > #add-icon'
        ).click();
        cy.get(
        ...
        cy.get(
            '#mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.dokumentbeskrivelse\\.elementMappings\\.0\\.valueMappingPerKey\\.dokumentstatus\\.mappingString-option-1'
        ).click();
        cy.get(
            '#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.objectCollectionMappingPerKey\\.journalpost\\.elementMappings\\.0\\.objectCollectionMappingPerKey\\.dokumentbeskrivelse\\.elementMappings\\.0\\.valueMappingPerKey\\.dokumentstatus\\.mappingString > .MuiAutocomplete-root > .MuiFormControl-root > .MuiInputBase-root'
        )
            .type('$vc{1}$if{bnr}', {
                parseSpecialCharSequences: false,
                delay: 0,
...
describe('Testing fill, save and complete new configuration', () => {
    ...
    it('should show error on missing required fields on saving completed configuration', () => {
        ...
        cy.get('#form-submit-btn').click();
        cy.get('#string-value-component-comment > .MuiTypography-root').should(
            'contain.text',
                    ...
                    objectMappingPerKey: {
                        newCase: {
                            ...
                            valueMappingPerKey: {
                                ...
                                tittel: {
                                    mappingString: 'test ferdigstilling',
                                    type: 'DYNAMIC_STRING',
                                },
                            },
                        },
