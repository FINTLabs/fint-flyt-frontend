...
describe('Testing fill, validate and complete new configuration', () => {
    ...
    it('should show validation error on fields not meeting rules fields on saving completed configuration', () => {
        ...
        cy.get(
            '#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.tittel\\.mappingString > .MuiTypography-root'
        ...
        cy.get('#form-submit-btn').click();
        cy.get(
            '#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.arkivdel\\.mappingString > .MuiTypography-root'
        ).should('contain.text', 'Feltet oppfyller ikke påkrevd format');
        cy.get(
            '#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.arkivdel\\.mappingString > .MuiAutocomplete-root > .MuiFormControl-root > .MuiInputBase-root'
        ).type('{backspace}');
