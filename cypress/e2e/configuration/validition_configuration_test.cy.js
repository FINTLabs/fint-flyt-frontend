...
describe('Testing fill, validate and complete new configuration', () => {
    ...
    it('should show validation error on fields not meeting rules fields on saving completed configuration', () => {
        ...
        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.tittel\\.mappingString > .MuiAutocomplete-root > .MuiFormControl-root > .MuiInputBase-root').type('$if{test', {parseSpecialCharSequences: false, delay: 0}).type('{enter}');
        ...
        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.saksmappetype\\.mappingString > .MuiFormControl-root > .MuiInputBase-root').type('$if{feil}', {parseSpecialCharSequences: false, delay: 0})
        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.arkivdel\\.mappingString > .MuiFormControl-root > .MuiInputBase-root').type('$vc{1}$if{testy}', {parseSpecialCharSequences: false, delay: 0})
        ...
        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.saksmappetype\\.mappingString > .MuiFormControl-root > .MuiInputBase-root').type('$vc{1}$if{ikke_feil}', {parseSpecialCharSequences: false, delay: 0})

        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.tittel\\.mappingString > .MuiAutocomplete-root > .MuiFormControl-root > .MuiInputBase-root').type('{backspace}')
        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.tittel\\.mappingString > .MuiAutocomplete-root > .MuiFormControl-root > .MuiInputBase-root').type('$if{test}', {parseSpecialCharSequences: false, delay: 0}).type('{enter}');
        ...
        cy.get('#dnd-value-component-mapping\\.objectMappingPerKey\\.newCase\\.valueMappingPerKey\\.arkivdel\\.mappingString > .MuiFormControl-root > .MuiInputBase-root').type('$if{testy}', {parseSpecialCharSequences: false, delay: 0})
