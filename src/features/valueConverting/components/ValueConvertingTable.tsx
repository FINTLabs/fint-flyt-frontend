		...
		>
			<VStack gap={"6"}>
							...
							{sortData?.map((value, i) => {
								return (
									<Table.ExpandableRow
										...
										key={i}
										content={
											<ValueConvertingPanel existingValueConverting={value} />
										}
									>
										...
										<Table.DataCell scope="row">
											{getSourceApplicationDisplayName(value.fromApplicationId)}
										</Table.DataCell>
										<Table.DataCell scope="row">
				...
				<HStack gap={"2"} align="center">
					<ButtonAks
						id={"new-button"}
						onClick={() => props.setNewValueConverting(true)}
					>
