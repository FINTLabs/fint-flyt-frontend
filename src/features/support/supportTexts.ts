...
const USER_GUIDE = [
    ...
    "Fyll ut konfigurasjonsoppsettet, dersom du skal ferdigstille og aktivere velger du det i sjekkboksene nederst på siden. Det er ikke mulig å aktivere før du har valgt fullført. Det er ikke påkrevd å aktivere en konfigurasjon ved ferdigstilling, men Flyt vil ikke motta og behandle instanser for en intagrasjon, før den har en aktiv konfigurasjon",
    "Dersom du vil legge til, endre eller se på konfigurasjonene til en integrasjon, gå til 'Integrasjoner' i menyen til venstre, velg integrasjonen du vil se på og trykk 'Vis'. Da vil du få oversikt over utkast, ferdigstilte og hvilken konfigurasjon som er eventuelt er aktiv." +
