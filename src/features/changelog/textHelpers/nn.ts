...
export const VERSION_DATA_NN: VersionEntry[] = [
    {
        ...
        updates: [
            ...
            {
                title: 'Redigere verdikonverteringar:',
                text: 'Det er no mogleg å redigere ei eksisterande verdikonvertering direkte frå handlingar i tabellen.',
            },
            {
                title: 'Slette verdikonverteringar:',
                text: 'Verdikonverteringar kan no slettast frå handlingar i tabellen.',
            },
            {
    ...
    },
    {
        ...
        updates: [
            {
                title: 'Forbetra vising av feilmeldingar på instansar:',
                text: 'Når du opnar ei feilmelding på ei instanshending, vert teksten no tydelegare. Forklaringa og sjølve feildetaljane er skilde, slik at det er enklare å lese kva som gjekk gale.',
            },
            {
                title: 'Informasjon når eldre feilmeldingar ikkje lenger finst:',
                text: 'Feilmeldingar på hendingar eldre enn 60 dagar kan ikkje lenger visast. Du får no ei forklaring om kvifor meldinga manglar, medan hendinga framleis vert vist i lista.',
            }
        ],
    },
    {
        ...
        updates: [
            {
                ...
                text: 'Lista over metadata og verdikonverteringar kan no skjulast og visast etter behov. I tillegg er det gjort fleire mindre forbetringar i design og brukaroppleving.',
            },
            {
    ...
    },
    {
        ...
        updates: [
            {
                title: 'Tydlegare feilmeldingar i konfigurasjonsoppsett:',
                text: 'Feilmeldingane ved lagring av ein konfigurasjon er forbetra. Det kjem no tydelegare fram kva felt som inneheld feil, og om det skuldast utdaterte referansar.',
            },
            {
                title: 'Betre tilbakemelding ved lagring av konfigurasjon:',
                text: 'Skjemaet viser no tydeleg når lagring er i gang, og gir klar beskjed om lagringa var vellukka eller ikkje.',
            },
            {
                title: 'Forbetra design for versjonar og utkast:',
                text: 'Tabellane for versjonar og utkast er forenkla. Aktiv versjon er tydeleg markert, og ID-kolonnen er fjerna. ID finst framleis i menyen for kvar konfigurasjon.',
            },
            {
                title: 'Støtte for sletting av utkast:',
                text: 'Det er no mogleg å slette utkast av konfigurasjonar.',
            },
        ],
    },
    {
        ...
        updates: [
            {
                ...
                text: 'Fleire rammer rundt tabellar og element er fjerna, og fargebruken er justert for betre samsvar med Novari-profilen.',
            },
            {
                title: 'Dashboard:',
