...
const DocumentForm: React.FunctionComponent<any> = (props) => {
    ...
    const documentFormFields: IInputField[] = [
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "Tittel", formValue: "documentData.title", required: required, error:errors.documentData?.title, value: props.watch("documentData.title")},
