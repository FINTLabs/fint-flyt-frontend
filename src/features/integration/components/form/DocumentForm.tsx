...
const DocumentForm: React.FunctionComponent<any> = (props) => {
    ...
    const documentFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.documentType", value: props.watch("documentData.documentType"), formValue: "documentData.documentType", dropDownItems: documentTypes, required: required, error:errors.documentData?.documentType, helpText: "documentData.documentType"},
