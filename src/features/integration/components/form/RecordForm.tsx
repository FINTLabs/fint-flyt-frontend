...
const RecordForm: React.FunctionComponent<any> = (props) => {
    ...
    const recordFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.type", value: props.watch("recordData.type"), formValue: "recordData.type", dropDownItems: documentTypes, required: false, error:errors.recordData?.type, helpText: "recordData.type"},
