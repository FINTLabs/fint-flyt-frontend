...
const RecordForm: React.FunctionComponent<any> = (props) => {
    ...
    const recordFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "labels.recordStatus", value: props.watch("recordData.recordStatus"), formValue: "recordData.recordStatus", dropDownItems: recordStatuses, required: false, error:errors.recordData?.recordStatus, helpText: "recordData.recordStatus"},
