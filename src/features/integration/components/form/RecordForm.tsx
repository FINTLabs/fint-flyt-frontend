...
const RecordForm: React.FunctionComponent<any> = (props) => {
    ...
    const recordFormFields: IInputField[] = [
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "labels.title", formValue: "recordData.title", required: false, error:errors.recordData?.title, value: props.activeFormData?.recordData?.title, helpText: "recordData.title"},
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.documentType", value: props.watch("recordData.documentType"), formValue: "recordData.documentType", dropDownItems: documentTypes, required: false, error:errors.recordData?.documentType, helpText: "recordData.documentType"},
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.recordStatus", value: props.watch("recordData.recordStatus"), formValue: "recordData.recordStatus", dropDownItems: recordStatuses, required: false, error:errors.recordData?.recordStatus, helpText: "recordData.recordStatus"},
