...
const RecordForm: React.FunctionComponent<any> = (props) => {
    ...
    const recordFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "labels.accessCode", value: props.watch("recordData.accessCode"), formValue: "recordData.accessCode", dropDownItems: accessCodes, required: false, error:errors.recordData?.accessCode, helpText: "recordData.accessCode"},
