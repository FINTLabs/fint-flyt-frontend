...
const CaseForm: React.FunctionComponent<any> = (props) => {
    ...
    const caseFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.archiveUnit", hidden: isExisting, value: props.watch("caseData.archiveUnit"), formValue: "caseData.archiveUnit", dropDownItems: archiveSections, required: required && isExisting, error:errors.caseData?.archiveUnit, helpText: "caseData.archiveUnit"},
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.accessCode", hidden: isExisting, value: props.watch("caseData.accessCode"), formValue: "caseData.accessCode", dropDownItems: accessCodes, required: required && isExisting, error:errors.caseData?.accessCode, helpText: "caseData.accessCode"},
