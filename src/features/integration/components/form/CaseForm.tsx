...
const CaseForm: React.FunctionComponent<any> = (props) => {
    ...
    const caseFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "Saksansvarlig", value: props.watch("caseData.caseWorker"), formValue: "caseData.caseWorker", dropDownItems: caseWorkers, required: required, error:errors.caseData?.caseWorker},
