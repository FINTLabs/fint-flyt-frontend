...
const CaseForm: React.FunctionComponent<any> = (props) => {
    ...
    const caseFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "Administrativ enhet", value: props.watch("caseData.administrativeUnit"), formValue: "caseData.administrativeUnit", dropDownItems: props.resources.administrativeUnits, required: required, error:errors.caseData?.administrativeUnit},
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "Tilgangskode", value: props.watch("caseData.accessCode"), formValue: "caseData.accessCode", dropDownItems: props.resources.accessCodes, required: required, error:errors.caseData?.accessCode},
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "Hjemmel", value: props.watch("caseData.paragraph"), formValue: "caseData.paragraph", dropDownItems: props.resources.paragraphs, required: required, error:errors.caseData?.paragraph},
