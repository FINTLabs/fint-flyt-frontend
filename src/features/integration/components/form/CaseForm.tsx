...
const CaseForm: React.FunctionComponent<any> = (props) => {
    ...
    const caseFormFields: IInputField[] = [
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "Tittel", formValue: "caseData.title", required: required, error:errors.caseData?.title, value: props.watch("caseData.title")},
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "Offentlig tittel", formValue: "caseData.publicTitle", required: required, error:errors.caseData?.publicTitle, value: props.watch("caseData.publicTitle")},
        ...
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "Primær ordningsprinsipp", formValue: "caseData.primaryClassification", required: required, error:errors.caseData?.primaryClassification, value: props.watch("caseData.primaryClassification")},
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "Sekundær ordningsprinsipp", formValue: "caseData.secondaryClassification", required: required, error:errors.caseData?.secondaryClassification, value: props.watch("caseData.secondaryClassification")},
