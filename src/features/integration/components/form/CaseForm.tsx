...
const CaseForm: React.FunctionComponent<any> = (props) => {
    ...
    const caseFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.caseType", value: props.watch("caseData.caseType"), formValue: "caseData.caseType", dropDownItems: dropdownPlaceholder, required: false, error:errors.caseData?.caseType, helpText: "caseData.caseType"},
