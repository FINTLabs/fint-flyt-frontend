...
const CaseForm: React.FunctionComponent<any> = (props) => {
    const caseFormFields: IInputField[] = [
        {input: INPUT_TYPE.TEXT_FIELD, label: "Tittel", formValue: "caseData.title"},
        {input: INPUT_TYPE.TEXT_FIELD, label: "Offentlig tittel", formValue: "caseData.publicTitle"},
        ...
        {input: INPUT_TYPE.TEXT_FIELD, label: "Primær ordningsprinsipp", formValue: "caseData.primaryClassification"},
        {input: INPUT_TYPE.TEXT_FIELD, label: "Sekundær ordningsprinsipp", formValue: "caseData.secondaryClassification"},
