...
const CaseForm: React.FunctionComponent<any> = (props) => {
    ...
    const caseFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "Journalenhet", value: props.watch("caseData.recordUnit"), formValue: "caseData.recordUnit", dropDownItems: props.administrativeUnits, required: required, error:errors.caseData?.recordUnit},
        {input: INPUT_TYPE.DROPDOWN, label: "Status", value: props.watch("caseData.status"), formValue: "caseData.status", dropDownItems: props.statuses, required: required, error:errors.caseData?.status},
        ...
        {input: INPUT_TYPE.AUTOCOMPLETE, label: "Primærklasse", value: props.watch("caseData.primaryClass"), formValue: "caseData.primaryClass", dropDownItems: props.primaryClass, required: required, error:errors.caseData?.primaryClass},
