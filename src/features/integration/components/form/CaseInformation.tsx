...
const CaseInformation: React.FunctionComponent<any> = (props) => {
    ...
    const caseInformationFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "labels.sourceApplicationIntegrationId", value: sourceApplicationIntegrationId, formValue: "sourceApplicationIntegrationId", dropDownItems: allForms.sourceApplicationForms, disabled: true, lockIcon: true},        {input: INPUT_TYPE.TEXT_FIELD, label: "labels.description", formValue: "description", error:errors.description, helpText: "description"},
