...
import {IConfiguration, IObjectCollectionMapping, IObjectMapping} from "../../../configuration/types/Configuration";

export function toAVFormData(data: IConfiguration): IFormConfiguration {
    ...
    const documentDescription: IObjectCollectionMapping = recordFields.objectCollectionMappingPerKey['dokumentbeskrivelse'] ? recordFields.objectCollectionMappingPerKey['dokumentbeskrivelse'] : {objectMappings: [], objectsFromCollectionMappings: []};
    const mainDocumentFields: IObjectMapping = documentDescription.objectMappings[0] ? documentDescription.objectMappings[0] : {objectMappingPerKey: {}, objectCollectionMappingPerKey: {}, valueMappingPerKey: {}, valueCollectionMappingPerKey: {}}
    const mainDocumentObjectFields: IObjectMapping = mainDocumentFields.objectCollectionMappingPerKey['dokumentobjekt']?.objectMappings[0] ? mainDocumentFields.objectCollectionMappingPerKey['dokumentobjekt'].objectMappings[0] : {objectMappingPerKey: {}, objectCollectionMappingPerKey: {}, valueMappingPerKey: {}, valueCollectionMappingPerKey: {}}
    const attachmentDocumentFields: IObjectMapping = documentDescription.objectsFromCollectionMappings[0]?.objectMapping ? documentDescription.objectsFromCollectionMappings[0].objectMapping : {objectMappingPerKey: {}, objectCollectionMappingPerKey: {}, valueMappingPerKey: {}, valueCollectionMappingPerKey: {}}
    const attachmentDocumentObjectFields: IObjectMapping = attachmentDocumentFields.objectCollectionMappingPerKey['dokumentobjekt']?.objectMappings[0] ? attachmentDocumentFields.objectCollectionMappingPerKey['dokumentobjekt'].objectMappings[0] : {objectMappingPerKey: {}, objectCollectionMappingPerKey: {}, valueMappingPerKey: {}, valueCollectionMappingPerKey: {}}

    const correspondent: IObjectCollectionMapping = recordFields.objectCollectionMappingPerKey['korrespondansepart'] ? recordFields.objectCollectionMappingPerKey['korrespondansepart'] : {objectMappings: [], objectsFromCollectionMappings: []};
    const correspondentFields: IObjectMapping = correspondent.objectMappings[0] ? correspondent.objectMappings[0] : {objectMappingPerKey: {}, objectCollectionMappingPerKey: {}, valueMappingPerKey: {}, valueCollectionMappingPerKey: {}}
