...
describe('testing value field utils', () => {
    ...
    it('should get correct tag styles based on tag', () => {
        ...
        expect(getTagStyles('tag', false))
            .toEqual({borderColor: "#eeeeee", "borderRadius": "1px", "color": "black", background: 'white', "& .MuiChip-label": {padding: 0.5}})
        expect(getTagStyles('tag', true))
            .toEqual({borderColor: "#eeeeee", "borderRadius": "1px", "color": "gray", background: 'white', "& .MuiChip-label": {padding: 0.5}})
    })
})
