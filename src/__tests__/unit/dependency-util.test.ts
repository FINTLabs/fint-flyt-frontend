import {
    getCombinationValue,
    getPredicateValue,
} from '../../features/configuration/util/DependencyUtils';
...
describe('test dependency utils', () => {
    ...
    it('getCombinationValue returns correct value', () => {
        const valuePerValueRef: Record<string, string> = {
            absoluteKey: 'keyString',
            absoluteSecondKey: 'keyTwoString',
        };
        ...
        const falseCombination: IValuePredicate[] = [
            { key: 'absoluteKey', defined: true, value: 'keyString', notValue: undefined },
            {
                key: 'absoluteSecondKey',
                defined: true,
                value: 'secondValue',
                notValue: 'keyTwoString',
            },
        ];
