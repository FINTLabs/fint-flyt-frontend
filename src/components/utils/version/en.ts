...
export const VERSION_DATA_EN: VersionEntry[] = [
    {
        ...
        updates: ['You can now see who changed a configuration and when the change was made.'],
    },
    {
        heading: 'June 2025',
        updates: [
    ...
    },
    {
        ...
        updates: ['Support for VIGO OT', 'Added better and more precise error handling'],
    },
    {
        heading: 'September 2024',
        updates: ['Deletion of cached instances', 'Added access control for source application'],
    },
    {
        heading: 'August 2024',
        updates: ['Added manual handling of instances'],
    },
    {
        heading: 'April 2024',
        updates: [
