...
export const VERSION_DATA: VersionEntry[] = [
    ...
    },
    {
        ...
        updates: ['Konverter til nytt Novari-tema', 'Flyttet rullefelt til vindu, still fokus'],
    },
    {
        heading: 'Oktober 2024',
        updates: ['Støtte for VIGO OT', 'Lagt til bedre og mer presis feilhåndtering'],
    },
    {
    ...
    {
        heading: 'August 2024',
        updates: ['Lagt til manuell behandling av instanser'],
    },
    {
        heading: 'April 2024',
        updates: [
